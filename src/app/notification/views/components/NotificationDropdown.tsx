      ...
      <div className="p-4 border-b border-slate-100 dark:border-slate-800 flex items-center justify-between bg-slate-50/50 dark:bg-slate-900/50">
        ...
        {unreadCount > 0 && (
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-semibold text-teal-600 hover:text-teal-700 dark:text-teal-400 dark:hover:text-teal-300 hover:bg-teal-50 dark:hover:bg-teal-950/30 rounded-xl transition-all"
              ...
              <div
                ...
                className={`p-3.5 group relative flex items-start gap-3 transition-colors ${
                  notif.isRead
                    ...
                    : "bg-teal-500/5 dark:bg-teal-950/20"
                }`}
              >
                {/* Indicator dot */}
                {!notif.isRead && (
                  <span className="absolute left-1.5 top-5 w-2 h-2 rounded-full bg-teal-500" />
                )}
