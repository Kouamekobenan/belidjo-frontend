    ...
    <div className="min-h-screen bg-gray-50 p-4 md:p-12">
      <div className="max-w-7xl mx-auto">
        ...
        <header className="flex flex-col gap-4 sm:flex-row justify-between items-center mb-8 p-6 bg-white shadow-xl rounded-2xl border border-cyan-100">
          ...
          <Link
            href={PRODUCT_CREATE_PATH}
            className="inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-xl shadow-lg text-white bg-green-600 hover:bg-green-700 transition duration-300 transform hover:scale-[1.03]"
          >
            <svg
                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    {products.map((p) => (
                      <tr key={p.id} className="hover:bg-gray-50">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-base font-semibold text-green-600 price">
                    ...
                    <Link href={detailLink} className="flex-grow">
                      ...
                      <div className="p-3 sm:p-4 flex flex-col justify-between flex-grow">
                        ...
                        <div className="flex flex-col mb-2">
                          <span className="text-sm sm:text-xl font-extrabold text-green-600 price">
