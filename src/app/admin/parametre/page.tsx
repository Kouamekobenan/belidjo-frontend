...
import ParamVendor from "../ui/components/parametre/ParamVendor";

export default function ParamVendorPage() {
  const { user } = useAuth();
  if (!user) {
    return (
          ...
          <div className="bg-white rounded-3xl shadow-2xl p-8 text-center space-y-6 border border-gray-100">
            ...
            <div className="space-y-3">
              ...
              <p className="text-gray-600 leading-relaxed">
                Veuillez vous connecter pour accéder vos paramètrages.
              </p>
            </div>
  ...
  return (
    <div className="flex min-h-screen bg-gray-50 w-full min-w-0 max-w-full overflow-x-hidden">
      ...
      />
      <main className="flex-1 w-full min-w-0 max-w-full overflow-x-hidden pt-20 md:pt-2 mb-20">
